...
@Component({
  ...
  template: `
    <main class="page notifications-page">
      ...
      <div class="notice warning">Alerts are evaluated only while this browser refreshes the watchlist. They are educational monitoring tools, not real-time trading signals.</div>
